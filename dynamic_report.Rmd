...
Taking into account all of the cat interaction score ratings, the mean interaction score rating is <b>`r mean_score`</b> out of 10. 

Tallying up all the submissions in the form I used for my investigation, <b>`r amount_of_scores`</b> score ratings were submitted.
